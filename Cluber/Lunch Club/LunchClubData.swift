...
struct LunchClubList {
    ...
    // Monday
        LunchClubStruct(clubName: "LOVE", teacherName: "Mrs. Jolly", groupImage: "HSLOVE", subName: "LGBTQ+ Organization for Various Ethnicities", description: "LOVE aims to recognize and respect everyone, no matter what gender / sexual orientation they identify themselves as. We are also working towards creating an environment that opposes discrimination against people part of the LGBTQ+ community.", dayOfWeek: 1, roomNumber: 0, location: "Conference Room 2"),
        
        LunchClubStruct(clubName: "KISBC", teacherName: "Mr. Crewe", groupImage: "KISBC", subName: "Korea International Synthetic Biology Cooperative" , description: "KISBC is a club for students aspiring to major in biology, biomedical engineering, and pre-medicine/dental sciences. Students will (1) compose an experimental proposal / systematic review for publication and award, (2) participate in the biology olympiad (e.g., British Biology Olympiad), and (3) host STEM education initiatives for the local and DIS community.", dayOfWeek: 1, roomNumber: 405, socialMedia: true, instagramLink: "https://www.instagram.com/kisbc_dis_official", instagramID: "@kisbc_dis_official"),
        ...
        LunchClubStruct(clubName: "Health Occupations Students of America", teacherName: "Mr. Hortezuela", groupImage: "n/a", subName: "HOSA",description: "HOSA (Health Occupations Students of America) is an international student organization endorsed by the U.S. Department of Education, aimed at students interested in health careers, providing them with leadership development, educational enhancement, and networking opportunities.", dayOfWeek: 1, roomNumber: 204, aiGenerated: true),
        
        LunchClubStruct(clubName: "Latin Club", teacherName: "Mr. Jolly", groupImage: "n/a", description: "Whether you’re a language enthusiast, a history buff, or simply curious about classical traditions, the Latin Club offers a space to explore and celebrate all things Latin. From learning about Roman myths and proverbs to delving into ancient texts, this club is a gateway to the past that enriches the present.", dayOfWeek: 1, roomNumber: 110, aiGenerated: true),
        
        LunchClubStruct(clubName: "Drama Club", teacherName: "Ms. Nagy", groupImage: "n/a", subName: "", description: "Do you like acting? Would you like to be part of a production? Come to Drama Club to showcase your passion for storytelling! This club is led by Ms. Nagy along with student support. We are seeking young actors from grades 6-12. Students will have the opportunity to practice acting, composing a play, and work in groups. For the duration of the trimester, our ultimate goal is to hold a performance at the assembly for our DIS community to enjoy!", dayOfWeek: 1, roomNumber: 306),
    ...
    // Tuesday
        ...
        LunchClubStruct(clubName: "Amnesty International", teacherName: "Ms. Loustch", groupImage: "n/a", description: "Join Amnesty International, where your voice can become a force for human rights, advocating for justice, freedom, and equality across the globe. Become part of a community committed to taking action against abuses, ensuring no one is left to fight for their rights alone.", dayOfWeek: 2, roomNumber: 314),
    ...
    // Wednesaday
        ...
        LunchClubStruct(clubName: "GIDAS", teacherName: "Mr. Crewe", groupImage: "GIDAS", subName: "Genes In Diseases and Symptoms Club", description: "GIDAS focuses on the study of genetic influences on diseases and symptoms, offering students the chance to engage in hands-on research and discussions on cutting-edge topics in genetics and biomedicine. Members can participate in projects and competitions that enhance their understanding of genetics’ role in medicine.", dayOfWeek: 3, roomNumber: 405, socialMedia: true, instagramLink: "https://www.instagram.com/disgidas/", instagramID: "@disgidas", aiGenerated: true),
        
        LunchClubStruct(clubName: "H.S. Book Club", teacherName: "Ms. Nagy", groupImage: "n/a", description: "Dive into the world of literature with the High School Book Club! Led by the passionate Ms. Nagy, this club invites students to explore captivating stories, thought-provoking themes, and diverse perspectives through the pages of great books. Whether you’re a seasoned reader or just beginning to discover the joys of reading, this club offers lively discussions, opportunities to share your favorite books, and a chance to connect with fellow book lovers.", dayOfWeek: 3, roomNumber: 306, aiGenerated: true),
        
        LunchClubStruct(clubName: "Why STEM", teacherName: "Mr. Hortezuela", groupImage: "n/a", description: "STEM equips individuals with the skills and knowledge to address global challenges, from climate change to medical advancements. Pursuing STEM fosters critical thinking, creativity, and collaboration, preparing students for high-demand careers and equipping them to be leaders in shaping a better tomorrow.", dayOfWeek: 3, roomNumber: 204, aiGenerated: true),
        ...
        LunchClubStruct(clubName: "Korean for Beginners", teacherName: "Ms. Loustch", groupImage: "n/a", description: "Learn Korean with Ms. Loustch", dayOfWeek: 4, roomNumber: 314),
        ...
        LunchClubStruct(clubName: "Eco-lution", teacherName: "Mrs. Lopez", groupImage: "ECO", subName: "Climate Science", description: "Ecolution promotes environmental sustainability through student-led initiatives and community engagement. Members participate in projects that focus on recycling, renewable energy, and conservation efforts to foster a greener campus and community.", dayOfWeek: 5, roomNumber: 210, socialMedia: true, instagramLink: "https://www.instagram.com/ecolution.cs/", instagramID: "@ecolution.cs", aiGenerated: true),
        
        LunchClubStruct(clubName: "High School Math Club", teacherName: "Ms. Wang", groupImage: "HSMT", description: "The High School Math Team provides students with opportunities to challenge and enhance their mathematical skills through competitions and problem-solving sessions. The club aims to foster a deep appreciation for mathematics and to develop strong analytical and reasoning abilities among its members.", dayOfWeek: 5, roomNumber: 202, aiGenerated: true),
    ...
    static let MiddleSchool = [
        ...
        // Wednesday
        LunchClubStruct(clubName: "Builder's Club", teacherName: "Mrs. Jolly", groupImage: "MSKeyClub", description: "MS Key Club introduces middle school students to volunteerism and leadership through service to their school and community. The club participates in various local and international service projects.", dayOfWeek: 3, roomNumber: 305, socialMedia: true, instagramLink: "https://www.instagram.com/keyclub_dis/", instagramID: "@keyclub_dis"),
        
        LunchClubStruct(clubName: "Byte to Byte", teacherName: "Mr. Gall", groupImage: "n/a", description: "", dayOfWeek: 3, roomNumber: 301),
